  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="glass-card p-6">
        <Label className="text-lg font-medium mb-4 block">Currency</Label>
      ...
      <div className="glass-card p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <Label className="text-lg font-medium">Hourly Rate</Label>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          💡 Tip: Your rate should reflect your experience and the value you provide.
        </p>
      </div>
    </div>
  );
